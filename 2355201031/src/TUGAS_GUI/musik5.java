 ...
 * @author alfa wijaya
 */
public class musik5 extends JFrame {
    ...
    private void initUI() {
        ...
        //menambahkan gambar
        ImageIcon imageIcon = new ImageIcon("src/gambar/as it was_1.jpg"); // Ganti gambar
        ...
        playButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                musicPlayer.playMusic("src/music/As_It_Was.wav"); //Ganti audio
            }
        });
