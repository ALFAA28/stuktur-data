 ...
 * @author alfa wijaya
 */
public class musik4 extends JFrame {
    ...
    private void initUI() {
        ...
        //menambahkan gambar
        ImageIcon imageIcon = new ImageIcon("src/gambar/left.jpg"); // Ganti gambar
        ...
        playButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                musicPlayer.playMusic("src/music/Left_and_Right_Feat_Jung_Kook_of_BTS_.wav"); //Ganti audio
            }
        });
