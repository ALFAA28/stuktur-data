 ...
 * @author alfa wijaya
 */
public class musik6 extends JFrame {
    ...
    private void initUI() {
        ...
        //menambahkan gambar
        ImageIcon imageIcon = new ImageIcon("src/gambar/angel.jpg"); // Ganti gambar
        ...
        playButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                musicPlayer.playMusic("src/music/Angel_Baby.wav"); //Ganti audio
            }
        });
