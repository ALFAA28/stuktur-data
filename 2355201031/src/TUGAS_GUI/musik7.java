 ...
 * @author alfa wijaya
 */
public class musik7 extends JFrame {
    ...
    private void initUI() {
        ...
        //menambahkan gambar
        ImageIcon imageIcon = new ImageIcon("src/gambar/Rewrite-The-Stars.jpg"); // Ganti dengan path gambar Anda
        ...
        playButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                musicPlayer.playMusic("src/music/Rewrite The Stars.wav");
            }
        });
